...
namespace CandlePatternML
{
    ...
    /// do other work
    /// </summary>
    public class FiveBarPatternModel
    {
        [NoColumn]
        ...
        [NoColumn]
        public Candle Hold4Candle { get; set; } // holding bar 3

        [NoColumn]
        public LowHighModel Hold4BarLowHigh { get; set; } // holding bar 3
        public float Hold4Low { get { return Hold4BarLowHigh.Low; } }
        public float Hold4High { get { return Hold4BarLowHigh.High; } }
        ...
        public float Hold4LowLessThanGapHigh { get; set; }
        public float Hold4HighMoreThanGapLow { get; set; }
        ...
        public void SetExtraFeatures()
        {
            ...
            Hold4LowLessThanGapHigh = Hold4Low < GapBarLowHigh.High ? 1.0f : 0.0f;
            Hold4HighMoreThanGapLow = Hold4High > GapBarLowHigh.Low ? 1.0f : 0.0f;
        }
